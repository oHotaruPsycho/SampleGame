...
(function() {
  ...
  // an accessor　追加分
  //
  Game_Map.prototype.foregroundName2 = function() {
    this.guardForeground();
    return this._foregroundName2;
};
  ...
  Game_Map.prototype.setupForeground = function() {
    this._foregroundName = $dataMap.meta.fgName1 || '';
...
//     追加分
    this._foregroundName2 = $dataMap.meta.fgName2 || '';
    this._foregroundZero2 = ImageManager.isZeroForeground(this._foregroundName2);
  };
  ...
  Spriteset_Map.prototype.createForeground = function() {
    ...
    this._foreground2 = new TilingSprite();
    this._foreground2.move(0, 0, Graphics.width, Graphics.height);
    ...
    this._baseSprite.addChild(this._foreground2);
  ...
  Spriteset_Map.prototype.updateForeground = function() {
    if (this._foregroundName !== $gameMap.foregroundName()) {
      ...
      this._foreground.blendMode = Number($dataMap.meta.fgBlend1) || 0;
      this._foreground.opacity = Number($dataMap.meta.fgOpacity1) || 255;
    }
...
//     ここも追加分
    if (this._foregroundName2 !== $gameMap.foregroundName()) {
      this._foregroundName2 = $gameMap.foregroundName2();
      this._foreground2.bitmap = ImageManager.loadParallax(this._foregroundName2);
      this._foreground2.blendMode = Number($dataMap.meta.fgBlend2) || 0;
      this._foreground2.opacity = Number($dataMap.meta.fgOpacity2) || 255;
    }
    if (this._foreground2.bitmap) {
      this._foreground2.origin.x = $gameMap.foregroundOx();
      this._foreground2.origin.y = $gameMap.foregroundOy();
    }
  };
